...
In der Abschlussaufgabe erweitern Sie den Mapper um k-mer-Spektrum basierte Fehlerkorrektur, um trotz Sequenzierfehlern im Datensatz belastbare Aussagen treffen zu können. Dann nutzen Sie Ihren Code, um bei vier Infektionen jeweils die zur Behandlung einsetzbaren Antibiotika vorzuschlagen. Abschließend implementieren Sie noch ein Tool, um aus pileup-files eine Distanzmatrix zu berechnen, die für eine phylogenetische Analyse genutzt werden kann. 
